        ...
        <main class="login_cadastramento">
            <div>
                ...
                <form method="post" action="./script/cadastro_perfil.php">
                    ...
                    <p>Telefone: <input class="form_login" type="number" name="telefone"></p>
                    <p>Telefone para recados: <input class="form_login" type="number" name="telefone_contato"></p>
                    <p>Região que reside da Cidade de São Paulo: <input class="form_login" type="text" name="regiao"></p>
